...
<div class="accordion" id="accordionUsuario">
    <div class="btn-group accordion-header">
        ...
        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExpediente" aria-expanded="true" aria-controls="collapseExpediente">
            Expediente
        </button>
